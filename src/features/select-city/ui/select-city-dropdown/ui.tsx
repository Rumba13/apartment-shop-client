...
export const SelectCityDropdown = observer(({ className }: Props) => {
   ...
   return <Select wrapperClassName={"select-city-dropdown-wrapper"} className={clsx("select-city-dropdown", className)} options={selectOptions} value={cityStore.city} onValueChanged={value => cityStore.setCity(value as City)} />;
});
