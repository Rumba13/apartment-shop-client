...
export const SelectCityBigDropdown = observer(({ className }: Props) => {
   ...
   return (
      <div className={"select-city-big-dropdown"}>
         <span className="dropdown__title">Город</span>

         <Select noArrow wrapperClassName={clsx("dropdown-wrapper")} className={"dropdown"} onValueChanged={city => cityStore.setCity(city as City)} options={getCitySelectOptions(t)} value={cityStore.city} />
