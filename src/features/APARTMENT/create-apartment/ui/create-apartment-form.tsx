...
export function CreateApartmentForm() {
   ...
   return (
      <div className="create-apartment-form-wrapper">
         <span className="create-apartment-form-wrapper__title">{t("Create Apartment")}</span>

         <Formik<ValuesType> initialValues={initialValues} validationSchema={schema} onSubmit={values => submit(values)}>
            {({ values }) => (
               <Form className="create-apartment-form" id="create-apartment-form">
                  ...
                  <Field name="sleepPlaces" placeholder="2+2+1" label={t("Sleep places")} />

                  <TariffField name="tariff" label={t("Tariffs")} />
                  <Field name="address" label={t("Address")} />
                  <FieldNumber name="area" min={1} label={t("Area")} />
                  ...
                  <button className="create-apartment-form__submit" type="submit">
                     {t("Add")}
                  </button>
               </Form>
            )}
