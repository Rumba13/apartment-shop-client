...
export const SnackBar = observer(({}: PropsType) => {
   ...
   return (
      <div className={clsx("snack-bar", snackBarStore.isAnimatingOpening ? "opening" : "closing")} onAnimationEnd={e => snackBarStore.setIsOpened(e.nativeEvent.animationName === "opening")}>
