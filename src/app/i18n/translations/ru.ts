export const russianTranslation = {
   ...
   "You can rent apartment":
      "На сайте 24kv.by вы можете легко и удобно снять квартиру на сутки для работы или отдыха. Мы предлагаем широкий выбор жилья в различных районах, чтобы вы могли выбрать идеальный вариант. Наши предложения актуальны и без посредников, что гарантирует лучшие цены и прозрачные условия. Найдите свою идеальную квартиру на Элит Тауэр!",
   "Gomel": "Гомель",
   "Brest": "Брест",
   "Grodno": "Гродно",
   "Pinsk": "Пинск",
