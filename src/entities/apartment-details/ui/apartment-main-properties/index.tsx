...
export function ApartmentMainProperties({ roomQuantity, sleepPlaces, guestQuantity, area }: PropsType) {
   ...
   if(screenWidth < 570)
   {
      return <div className={clsx("apartment-properties grid")}>
   ...
   return <div className="apartment-properties">
      <IconWithTwoTitles icon={RoomsIcon} title={roomQuantity}
                         subTitle={t("Room", { count: roomQuantity })} />
